...
public class ControleurEdition {
  ...
  public void actionBoutonAjouter() {
    ...
    try {
      ...
      Text t = new Text(
          "Erreur: Champ Vitesse (format incorrect: n�cessite un nombre -1<vitesse<410)" + "\n");
    ...
    try {
      ...
      Text t = new Text("Erreur: Champ Direction (format incorrect : n�cessite un nombre)" + "\n");
      t.setFill(Color.rgb(204, 0, 0));
      this.console.getChildren().add(t);
      this.scrollbas();
    }
    ...
    try {
      ...
      Text t = new Text(
          "Erreur: Champ Duree (format incorrect : n�cessite un nombre entier 0<duree<48)" + "\n");
      t.setFill(Color.rgb(204, 0, 0));
      this.console.getChildren().add(t);
      this.scrollbas();
    }
