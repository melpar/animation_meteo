...
public class TestModification {
  ...
  /**
   * Permet d'initialiser les données nécessaires aux tests.
   */
  @Before
  public void initialisation() {
    ...
    this.listePrevisionTest.ajouterDonneeVent(this.dateTest, 10, 50, (int) 3, (int) 4);// creation
    // d'un vent inferieur  a 190kmH
    this.listePrevisionTest.ajouterDonneeVent(this.dateTest, 20, 50, (int) 0, (int) 0);// creation
    // d'un vent  superieur a 190kmH
    this.listePrevisionTest.ajouterDonneeVent(this.dateTest, 30, 50, (int) 9, (int) 9);// creation
    // d'un vent superieur a 190kmH
  }
  ...
  public void testModifierContrasteProgressifVent() {
    ...
    ZonePrevision zonePrevisionTest = new ZonePrevision(1, 1, 5, 5, 10, 10);
    Visiteur modifier = new VisiteurContrasteProgressif(zonePrevisionTest, 0.5, 190);
    // seuil � 190 kmH
    listePrevisionTest.applique(modifier);
  ...
  public void testModifierContrasteLineaireVent() {
    ...
    ZonePrevision zonePrevisionTest = new ZonePrevision(1, 1, 5, 5, 10, 10);
    Visiteur modifier = new VisiteurContrasteLineaire(zonePrevisionTest, 0.5, 190);
    // seuil � 190 kmH
    listePrevisionTest.applique(modifier);
  ...
  public void testSeuilDefaut() {
    ...
    Visiteur modifier = new VisiteurContrasteLineaire(zonePrevisionTest, 1, 100);// seuil � 190 kmH
    listePrevisionTest.applique(modifier);
