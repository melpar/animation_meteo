...
public class Mail {
  ...
  public void setdonneeenvoyee(double lattitudepg, double lattitudepd, double longitudepg,
      double longitudepd) {
  ...
  public String getGribFile(double lattitudepg, double lattitudepd, double longitudepg,
      double longitudepd)
